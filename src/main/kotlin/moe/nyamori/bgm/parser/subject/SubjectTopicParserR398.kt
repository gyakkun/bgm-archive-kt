    ...
    override fun parseTopic(htmlFileString: String, topicId: Int, spaceType: SpaceType): Pair<Topic?, Boolean> {
        ...
        try {
            ...
            if (body.selectFirst("div#colunmNotice > div > p.text") != null || 
                ...
                return Pair(
                    Topic(id = topicId, space = Reserved(type = spaceType), display = false, state = Post.STATE_DELETED),
                    true
                )
            }

            val subjectNameAnchor = body.selectFirst("div#column_container > div.mainWrapper > div.columns > div > div#pageHeader > h1 > span > a.avatar")
            ...
            val topPostDivSmall = topPostDiv.selectFirst("div.inner > small") 
            ...
            val subjectName = subjectNameAnchor.attr("href").split("/").last()
            val subjectDisplayName = subjectNameAnchor.text()
            ...
            val thisTopic = Topic(
                id = topicId,
                space = Subject(type = spaceType, name = subjectName, displayName = subjectDisplayName),
            ...
            followPostDivList.forEachIndexed outer@{ outerIdx, floor ->
                ...
                if (isSpecialBadge) {
                    ...
                    val floorAnchor = floor.selectFirst("div.re_info > small > a.floor-anchor")
                        ?: floor.selectFirst("div.re_info > div.action > small > a.floor-anchor")!!
                    floorNum = floorAnchor.text().substring(1).toInt()
                    val floorDateSmall = floor.selectFirst("div.re_info > small")
                ...
                subFloorDivList.forEachIndexed inner@{ innerIdx, subFloor ->
                    ...
                    val subFloorAnchor = subFloor.selectFirst("div.re_info > small > a.floor-anchor")
                    ...
                    val subFloorDateSmall = subFloor.selectFirst("div.re_info > small")
