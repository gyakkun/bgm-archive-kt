...
object GroupTopicParserR400 : Parser {
    ...
    const val XP_FLOOR_ANCHOR_R400 =
        "div[contains(@class,\"post_actions\")]/div[contains(@class,\"action\")]/small/a[contains(@class,\"floor-anchor\")]"
    const val XP_FLOOR_DATE_SMALL_TEXT_R400 =
        "div[contains(@class,\"post_actions\")]/div[contains(@class,\"action\")]/small/text()"
