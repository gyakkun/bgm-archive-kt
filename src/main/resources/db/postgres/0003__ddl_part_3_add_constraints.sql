alter table public.meta_data
    drop constraint if exists meta_data_pk CASCADE;
...
alter table public.ba_user
    drop constraint if exists ba_user_pk CASCADE;
...
alter table public.ba_topic
    drop constraint if exists ba_topic_pk CASCADE;
...
alter table public.ba_post
    drop constraint if exists ba_post_pk CASCADE;
...
alter table public.ba_likes
    drop constraint if exists ba_likes_pk CASCADE;
...
alter table public.ba_space_naming_mapping
    drop constraint if exists ba_space_naming_mapping_pk CASCADE;
...
alter table public.ba_blog_subject_id_mapping
    drop constraint if exists ba_blog_subject_id_mapping_pk CASCADE;
...
alter table public.ba_blog_tag_mapping
    drop constraint if exists ba_blog_tag_mapping_pk CASCADE;
...
alter table public.ba_likes_rev
    drop constraint if exists ba_likes_rev_pk CASCADE;
...
alter table public.ba_cache_repo_commit
    drop constraint if exists ba_cache_repo_commit_pk CASCADE;
...
alter table public.ba_cache_repo_commit
    drop constraint if exists ba_cache_repo_commit_pk_2 CASCADE;
...
alter table public.ba_cache_file_relative_path
    drop constraint if exists ba_cache_file_relative_path_pk CASCADE;
...
alter table public.ba_cache_file_relative_path
    drop constraint if exists ba_cache_file_relative_path_pk_2 CASCADE;
...
alter table public.ba_cache_file_commit
    drop constraint if exists ba_cache_file_commit_pk CASCADE;
...
alter table public.ba_cache_file_commit
    drop constraint if exists ba_cache_file_commit_ba_cache_file_relative_path_id_fk CASCADE;
...
alter table public.ba_cache_file_commit
    drop constraint if exists ba_cache_file_commit_ba_cache_repo_commit_id_fk CASCADE;
